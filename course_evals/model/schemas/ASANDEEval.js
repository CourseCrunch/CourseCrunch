...
ASANDESchema.statics.getReccomendations = function (courses, filteredCourse, limit) {
    return this.aggregate([
        { $group: { _id: '$Code', Course_Workload: { $avg: { $toDecimal: '$Item_13' } }, Term: { $addToSet: { $concat: ['$Term', '$Year'] } } } },
